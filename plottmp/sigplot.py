...
def output_results(savefig_format, output_path, project, figs, context_type, dpi=100):
    print(f"Length of figs: {len(figs)} WTF")
...
def plotSBS(
    ...
    if plot_type == "96":
        ...
        print("AFTER PROCESS_INPUT BEFORE REINDEX_SBS96")
        ...
        return output_results(savefig_format, output_path, project, figs, "SBS_96", dpi=dpi) if not return_figs else figs
